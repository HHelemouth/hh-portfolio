    ...
    <div className="min-h-screen w-full overflow-x-hidden" style={{ backgroundColor: 'oklch(0.99 0 0)' }}>
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {['Étude de marché', 'Product Discovery', 'UX Research', 'Lancement produit'].map((t) => (
            <span
              key={t}
        ...
        >
          Concevoir un outil SaaS pour les managers de centre-ville, de la discovery à la vision produit, avec l'IA comme partenaire de travail.
        </p>
