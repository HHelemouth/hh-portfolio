...
const CHAPTERS: { id: string; label: Bi; bonus?: boolean }[] = [
  ...
  { id: 'perspectives', label: { fr: 'Perspectives', en: 'Perspectives' } },
  { id: 'ia', label: { fr: "L'IA dans la démarche", en: 'AI in the process' }, bonus: true },
];

const sectionTitle = (b: Bi, lang: Lang) => (
  <h2
...
const bodyText = (b: Bi, lang: Lang, className = '') => (
  <p
...
const h3 = (b: Bi, lang: Lang, extraClass = 'mt-8') => (
  <h3
  ...
  return (
    ...
    <div className="min-h-screen w-full" style={{ backgroundColor: 'oklch(0.99 0 0)' }}>
      ...
      <main className="content-col max-w-3xl lg:max-w-4xl xl:max-w-5xl py-8 sm:py-14">
        ...
        {active === 'contexte' && (
          <section>
            {sectionTitle({ fr: 'Un nouveau marché, une vraie opportunité', en: 'A new market, a real opportunity' }, lang)}
            {bodyText({
              ...
              en: "As part of a market study for Codata (Intescia group), I worked on a market barely addressed by digital tools yet: city-center managers. These professionals, usually attached to local authorities or retailer associations, drive the commercial and urban dynamics of their area. They lack tools suited to their reality on the ground.",
            }, lang)}
            <div className="my-6" />
            {bodyText({
              ...
              en: "The challenge was twofold: find out whether a real problem existed, and if so, define what a digital product could concretely bring to these users, without starting from a preconceived solution.",
            }, lang)}
            {accent({
              ...
              en: "\"A well-framed problem is half solved. Before drawing anything, I wanted to understand who these users really were and what was blocking them day to day.\"",
            }, lang)}

            {h3({ fr: 'Une équipe agile, un avantage décisif', en: 'An agile team, a decisive advantage' }, lang)}
            {bodyText({
              ...
              en: "Codata's team is unusually agile. When something isn't working, it can be fixed fast. That ability to iterate without friction was a real asset throughout the project: hypotheses could be tested, adjusted and redirected without waiting on long validation cycles. That's what made it possible to move fast on complex topics without ever losing sight of the user.",
            }, lang)}
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: '✏️', title: { fr: 'Vision', en: 'Vision' }, desc: { fr: 'Conception des parcours clés, wireframes, présentation aux parties prenantes', en: 'Design of key flows, wireframes, presentation to stakeholders' } },
              ].map((item) => (
                <div
                  key={item.title.fr}
        ...
        {active === 'personnas' && (
          <section>
            {sectionTitle({ fr: 'Comprendre avant de concevoir', en: 'Understanding before designing' }, lang)}
            {bodyText({
              ...
              en: "Before touching a single wireframe, I ran user interviews to understand who city-center managers really are. What became clear quickly was how varied the profiles were: some very comfortable with digital tools, others much less so, yet all sharing the same fundamental frustrations.",
            }, lang)}
            {accent({
              ...
              en: "The interface has to be accessible without being condescending. That's a strong design constraint when profiles range from managers with little digital experience to highly tooled-up ones.",
            }, lang)}
              ...
              {[
                {
                  ...
                  needs: [
                    { fr: 'Une vue consolidée et à jour des locaux commerciaux de son territoire', en: 'A consolidated, up-to-date view of commercial units in their area' },
                  ...
                  frustrations: [
                    ...
                    { fr: 'Apprend les changements de situation par le bouche-à-oreille', en: 'Finds out about status changes by word of mouth' },
                ...
                },
                {
                  ...
                  role: { fr: "Directeur d'association de commerçants", en: 'Director of a retailers association' },
                  color: '#1a1a6e',
                  ...
                  needs: [
                    ...
                    { fr: 'Gérer ses contacts (propriétaires, élus, commerçants) en un seul endroit', en: 'Manage contacts (owners, officials, retailers) in one place' },
                    { fr: 'Communiquer des données convaincantes à ses partenaires', en: 'Present convincing data to partners' },
                  ],
                  frustrations: [
                    ...
                    { fr: 'Manque de légitimité face aux élus sans données chiffrées', en: 'Lacks credibility with officials without hard data' },
                  ],
                },
              ].map((p) => (
                <div
                      ...
                      <ul className="space-y-2">
                        {p.frustrations.map((f) => (
                          <li
                            key={f.fr}
                            className="flex items-start gap-2 text-sm"
                            style={{ color: 'oklch(0.45 0.02 264)', fontFamily: 'DM Sans, sans-serif', lineHeight: 1.6 }}
                          >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { label: { fr: 'La vacance commerciale est un angle mort', en: 'Commercial vacancy is a blind spot' }, text: { fr: "Les managers n'ont pas de vue temps réel sur les locaux vacants. Ils apprennent souvent les changements de situation par le bouche-à-oreille.", en: "Managers have no real-time view of vacant units. They often find out about status changes by word of mouth." } },
                { label: { fr: "L'information zéro est une information", en: 'Zero information is still information' }, text: { fr: "Ne pas savoir pourquoi un local est vide depuis 18 mois est aussi précieux que de savoir qu'il est en négociation. L'outil doit rendre l'inconnu visible.", en: "Not knowing why a unit has been empty for 18 months is as valuable as knowing it's under negotiation. The tool needs to make the unknown visible." } },
                { label: { fr: 'Le comparatif territorial est un levier de légitimité', en: 'Territorial benchmarking is a credibility lever' }, text: { fr: "Pouvoir dire « mon taux de vacance est inférieur à la moyenne des villes comparables » change le rapport aux élus. La donnée comparative est une arme politique.", en: "Being able to say \"my vacancy rate is below the average for comparable cities\" changes the relationship with elected officials. Comparative data is a political tool." } },
                { label: { fr: 'Profils très hétérogènes', en: 'Highly varied profiles' }, text: { fr: "Du manager très digital au gestionnaire peu à l'aise avec les outils, l'interface doit être accessible sans être condescendante.", en: "From highly digital managers to those less comfortable with tools, the interface needs to be accessible without being condescending." } },
              ].map((item) => (
                <div
                  key={item.label.fr}
                  className="p-5 rounded-sm"
        ...
        {active === 'entretiens' && (
          <section>
            {sectionTitle({ fr: 'Le terrain challenge la promesse', en: 'Reality tests the promise' }, lang)}
            {bodyText({
              ...
              en: "Once the prototype was in place, it had to face reality. Four city-center managers (Orléans, Strasbourg, Limoges, Pau) tested the interface over video call, handling the Figma prototype themselves. The point wasn't to validate a pitch, but to watch live where the tool held up and where it cracked.",
            }, lang)}
            {accent({
              ...
              en: "Some things I'd presented as settled changed during the interviews themselves. This wasn't validation, it was co-construction.",
            }, lang)}

            {h3({ fr: 'Ce qui a été confirmé', en: 'What got confirmed' }, lang)}
              ...
              {[
                {
                  ...
                  desc: {
                    ...
                    en: 'In Limoges, Samuel put it most bluntly: "the more steps you have, the more tasks you have to do, the less you actually do." He immediately rejected the idea of an extra vacancy-qualification status on top of the vacant/occupied pair, in favor of a simple binary system with a direct switch to "under negotiation." That change was adopted.',
                  },
                },
                {
                  title: { fr: "Le rôle détermine l'usage", en: 'The role determines the usage' },
                  desc: {
                    ...
                    en: 'In Strasbourg, Thomas was explicit about how stale the existing data felt ("a frustration, I\'d even say") and about the value of matching prospects to units. In Limoges, Samuel, by contrast, found the Analysis module of almost no use for his job, revealing that this module actually serves other, more strategic profiles.',
                  },
                },
                {
                  ...
                  desc: {
                    ...
                    en: 'Flagged independently by Angélique (Orléans), Samuel (Limoges, "potential contact") and live during the Le Havre interview, where the shift happened in real time: "at first we thought \'brand\', then we crossed out \'brand\' for \'applicant\', but the real keyword is actually \'prospect\'." The term was changed on the spot.',
                  },
                },
              ].map((item) => (
                <div key={item.title.fr} className="p-4 rounded-lg border" style={{ borderColor: 'oklch(0.88 0.02 264)', background: 'oklch(0.97 0.01 264)' }}>
                  <div className="font-semibold mb-1" style={{ fontFamily: 'Jost, sans-serif', color: '#3B3FD8' }}>{item.title[lang]}</div>
                  <div className="text-sm leading-relaxed" style={{ color: 'oklch(0.35 0.02 264)' }}>{item.desc[lang]}</div>
                </div>
              ))}
            </div>

            {h3({ fr: 'Ce qui a fait bouger le produit', en: 'What actually changed the product' }, lang)}
            {bodyText({
              ...
              en: "The clearest case came from Strasbourg. The Occupied/Vacant status had been presented as locked, fully driven by Codata's data, to prevent local authorities from \"gaming\" their statistics. Anne-Cécile pushed back with a concrete case: a store that closed on January 15th stayed marked as occupied for a full year, because Codata's next survey also fell in January.",
            }, lang)}
            {accent({
              ...
              en: "That argument was enough to reverse the rule: the status became freely editable by the user, with Codata's value always kept and restorable in the background. It's never overwritten or lost, only weighed against the on-the-ground correction.",
            }, lang)}

            {h3({ fr: 'Une opportunité inattendue', en: 'An unexpected opportunity' }, lang)}
            {bodyText({
              ...
              en: "In Pau, Jérôme surfaced a strong, unanticipated commercial signal: his local authority pays roughly €18,000/year for MyTraffic (foot traffic, catchment area, purchasing power, socio-demographics), on top of their Codata subscription. His message was direct: \"if you offer those criteria in your solution, that could put our MyTraffic subscription into question (...) the choice would be quick to make.\"",
            }, lang)}
            {accent({
              ...
              en: "A clear signal: foot-traffic and catchment-area data isn't just a nice-to-have field, it's a genuine competitive differentiator.",
            }, lang)}

            {h3({ fr: 'Ce qui reste ouvert', en: 'What remains open' }, lang)}
            {bodyText({
              ...
              en: "The Engage pillar (gamification, badges, goals) wasn't tested in any of these four interviews. That's not an oversight: the development cost of those mechanics was judged too high to justify a place in an MVP focused on the strict functional minimum. Its relevance is therefore still entirely to be validated on the ground rather than assumed.",
            }, lang)}
            {bodyText({
              ...
              en: "These interviews also made the initial personas (Marie, Thomas) obsolete, since replaced by personas grounded in these four conversations: Camille (Orléans), Léa (Strasbourg), Vincent (Pau), Karim (Limoges), each revealing a different relationship to the tool, from the most operational to the most strategic.",
            }, lang)}
          </section>
        )}
        ...
        {active === 'architecture' && (
          <section>
            {sectionTitle({ fr: 'Structurer avant de dessiner', en: 'Structuring before drawing' }, lang)}
            {bodyText({
              ...
              en: "Once personas were set and needs identified, I worked on the site's information architecture. The challenge was finding a structure simple enough for less digital profiles, yet powerful enough for advanced users.",
            }, lang)}
            {accent({
              ...
              en: "The rule I set myself: every piece of information must be reachable in 2 clicks maximum from anywhere in the interface.",
            }, lang)}

            {h3({ fr: 'Les 4 modules structurants', en: 'The 4 structuring modules' }, lang)}
            <div className="space-y-3 mb-8">
              {[
                {
                  num: '1',
                  title: { fr: 'Carte des locaux', en: 'Unit map' },
                  desc: { fr: "Vue interactive avec statuts nuancés : vacant, en négociation, occupé, à risque. Historique des occupations pour chaque local. C'est le point d'entrée principal, celui que tous les profils utilisent en premier.", en: "Interactive view with nuanced statuses: vacant, under negotiation, occupied, at risk. Occupancy history for each unit. It's the main entry point, the one every profile uses first." },
                },
                {
                  num: '2',
                  title: { fr: 'Veille enseignes', en: 'Brand tracking' },
                  desc: { fr: "Recherche et suivi des enseignes cibles. Alertes sur les signaux de dynamique commerciale (ouvertures, fermetures, liquidations). Un outil de prospection intégré au quotidien du manager.", en: "Search and tracking of target brands. Alerts on commercial dynamics signals (openings, closures, liquidations). A prospecting tool built into the manager's daily routine." },
                },
                {
                  num: '3',
                  title: { fr: 'Mini-CRM territorial', en: 'Territorial mini-CRM' },
                  desc: { fr: "Gestion des contacts (propriétaires, commerçants, élus), suivi des échanges, gestion documentaire intégrée. Remplace les tableurs et les carnets d'adresses éparpillés.", en: "Contact management (owners, retailers, officials), exchange tracking, built-in document management. Replaces scattered spreadsheets and address books." },
                },
                {
                  num: '4',
                  title: { fr: 'Tableau de bord comparatif', en: 'Comparative dashboard' },
                  desc: { fr: "Indicateurs de performance du centre-ville, comparaison avec des villes de taille similaire, suivi des objectifs personnalisés. Le module qui donne de la légitimité aux managers face aux élus.", en: "City-center performance indicators, benchmarking against similarly sized cities, tracking of custom goals. The module that gives managers credibility with elected officials." },
                },
              ].map((item) => (
                <div
                  key={item.num}
            ...
            {h3({ fr: 'Les parcours clés conçus', en: 'The key flows designed' }, lang, 'mt-10')}
            <div className="space-y-4">
              {[
                { step: '01', title: { fr: 'Prise en main du tableau de bord', en: 'Getting started with the dashboard' }, text: { fr: "Premier contact avec la plateforme, découverte de la carte et des indicateurs clés. Pensé pour être compréhensible sans formation.", en: "First contact with the platform, discovering the map and key indicators. Designed to be understandable without training." } },
                { step: '02', title: { fr: "Mise à jour du statut d'un local", en: 'Updating a unit\'s status' }, text: { fr: "Action la plus fréquente du manager. Doit être rapide, intuitive, réalisable depuis le terrain (mobile).", en: "The manager's most frequent action. Needs to be fast, intuitive, doable from the field (mobile)." } },
                { step: '03', title: { fr: "Recherche d'une enseigne cible", en: 'Searching for a target brand' }, text: { fr: "Parcours de prospection : identifier une enseigne, consulter ses signaux, l'ajouter à une liste de suivi, programmer une alerte.", en: "Prospecting flow: identify a brand, check its signals, add it to a watch list, schedule an alert." } },
                { step: '04', title: { fr: 'Génération d\'un rapport pour les élus', en: 'Generating a report for officials' }, text: { fr: "Synthèse automatique des indicateurs du territoire, comparaison avec les villes similaires, export en un clic.", en: "Automatic summary of the area's indicators, comparison with similar cities, one-click export." } },
              ].map((item) => (
        ...
        {active === 'promesse' && (
          <section>
            {sectionTitle({ fr: 'Cibler, Détecter, Sécuriser, Engager', en: 'Target, Detect, Reassure, Engage' }, lang)}
            {bodyText({
              ...
              en: "City Manager isn't simply a commercial-vacancy detection tool. It's an engagement platform, designed to support the manager at every step of their work on the ground. This promise unfolds in four stages, matching the four main phases of a city-center manager's job.",
            }, lang)}
              ...
              {[
                {
                  ...
                  color: '#3B3FD8',
                  bg: 'oklch(0.94 0.04 264)',
                  desc: { fr: "Identifier les locaux prioritaires, les enseignes à fort potentiel, les zones à risque. L'IA analyse les données du territoire pour faire remonter les signaux faibles avant qu'ils ne deviennent des problèmes.", en: "Identify priority units, high-potential brands, at-risk zones. AI analyzes the area's data to surface weak signals before they become problems." },
                },
                {
                ...
                },
                {
                  ...
                  color: '#1a1a6e',
                  bg: 'oklch(0.95 0.02 264)',
                  desc: { fr: "Passer à l'action : contacter un propriétaire, proposer un local à une enseigne cible, partager un rapport avec les élus. La plateforme transforme l'information en action concrète, en un minimum de clics.", en: "Move to action: contact an owner, offer a unit to a target brand, share a report with officials. The platform turns information into concrete action, in as few clicks as possible." },
                },
              ].map((item) => (
                <div
                  key={item.word.fr}
            ...
            {h3({ fr: "L'IA et les algorithmes au cœur du produit", en: 'AI and algorithms at the core of the product' }, lang, 'mt-10')}
            {bodyText({
            ...
            {accent({
              ...
              en: "Reassuring information is a feature in its own right. A manager acting on reliable data is a manager who acts faster, and convinces the people they work with more easily.",
            }, lang)}
          </section>
        )}
        ...
        {active === 'gamification' && (
          <section>
            {sectionTitle({ fr: 'Un sujet qui a ouvert une réflexion au niveau groupe', en: 'A topic that opened a group-wide discussion' }, lang)}
            {bodyText({
              ...
              en: "As the project progressed, an unexpected topic emerged: gamification. The idea came from a simple observation: city-center managers often work alone, with no immediate feedback on their actions. They don't know whether what they do has an impact, and that lack of feedback can be demotivating over time.",
            }, lang)}
            {accent({
              fr: "Et si la plateforme récompensait les bonnes pratiques ? Et si elle rendait visible le progrès, pas seulement le résultat ?",
              en: "What if the platform rewarded good practice? What if it made progress visible, not just the outcome?",
            }, lang)}

            {h3({ fr: 'Les mécanismes explorés', en: 'Mechanics explored' }, lang)}
            <div className="space-y-3 mb-8">
              {[
                {
                  title: { fr: 'Indicateurs de progression', en: 'Progress indicators' },
                  desc: { fr: "Visualiser l'évolution du taux de vacance dans le temps, avec des jalons et des objectifs personnalisés. Rendre le progrès tangible, même quand il est lent.", en: "Visualize how the vacancy rate evolves over time, with milestones and custom goals. Make progress tangible, even when it's slow." },
                },
                {
                  title: { fr: 'Badges et reconnaissance', en: 'Badges and recognition' },
                  desc: { fr: "Valoriser les actions clés : premier local remis en activité, 10 enseignes suivies, rapport partagé avec les élus. Des marqueurs symboliques qui donnent du sens au travail quotidien.", en: "Highlight key actions: first unit brought back into use, 10 brands tracked, report shared with officials. Symbolic markers that give meaning to day-to-day work." },
                },
                {
                  title: { fr: 'Comparaison entre territoires', en: 'Comparison between areas' },
                  desc: { fr: "Un classement bienveillant entre villes comparables, qui stimule sans stigmatiser. L'objectif n'est pas de créer de la compétition, mais de l'émulation positive.", en: "A friendly ranking between comparable cities, that motivates without stigmatizing. The goal isn't to create competition, but positive emulation." },
                },
                {
                  title: { fr: 'Streaks et régularité', en: 'Streaks and consistency' },
                  desc: { fr: "Encourager la mise à jour régulière des données (un local mis à jour par semaine, une enseigne suivie par mois). La plateforme devient un outil de routine professionnelle.", en: "Encourage regular data updates (one unit updated per week, one brand tracked per month). The platform becomes part of the professional routine." },
                },
              ].map((item) => (
                <div
                  key={item.title.fr}
            ...
            {h3({ fr: 'Un sujet qui dépasse City Manager', en: 'A topic bigger than City Manager' }, lang, 'mt-10')}
            {bodyText({
              ...
              en: "What started as a UX improvement idea became a group-wide discussion topic at Intescia. The broader question: how do you build engagement mechanics into B2B tools without it feeling gimmicky? How do you make a professional tool motivating without turning it into a game?",
            }, lang)}
            {bodyText({
              ...
              en: "That discussion is ongoing. City Manager served as a testing ground for a topic that could eventually inform other products in the ecosystem.",
            }, lang)}
          </section>
        )}
        ...
        {active === 'ia' && (
          <section>
            {sectionTitle({ fr: "L'IA comme partenaire de travail", en: 'AI as a working partner' }, lang)}
            {bodyText({
              ...
              en: "This project was an opportunity to bring AI into my design process in a concrete, structured way, not as a gimmick, but as a real working partner. From discovery through to design, AI was present at every step.",
            }, lang)}
            ...
            <div className="mt-8 space-y-6">
              {[
                {
                  num: '01',
                  title: { fr: 'Accompagnement dès la phase de discovery', en: 'Support from the discovery phase onward' },
                  desc: {
                ...
                },
                {
                  ...
                  desc: {
                    ...
                    en: "For the early wireframe iterations, I used Figma Make to quickly generate interface variants from text descriptions. That let me explore a wider solution space in less time, and present concrete options to stakeholders as early as the first meetings.",
                  },
                  tag: 'Figma Make',
                },
                {
                  ...
                  desc: {
                    ...
                    en: "Building the design system was supported by Claude (Anthropic) to structure the token architecture, document decisions, and generate early versions of the guidelines. AI didn't replace design judgment, it sped up documentation production and helped keep things consistent across iterations.",
                  },
                  tag: 'Claude',
                },
              ].map((item) => (
            ...
            {h3({ fr: "L'IA dans le produit lui-même", en: 'AI in the product itself' }, lang)}
            {bodyText({
              ...
              en: "Beyond the design process itself, AI is also at the core of the City Manager product. The algorithms that cross-reference territorial data, detect weak signals and generate actionable insights are themselves AI systems. Designing an interface that makes those algorithms understandable and usable by non-experts was one of the most stimulating design challenges of the project.",
            }, lang)}
          </section>
        )}
        ...
        {active === 'perspectives' && (
          <section>
            {sectionTitle({ fr: "Une plateforme prometteuse, un marché qui s'élargit", en: 'A promising platform, a widening market' }, lang)}
            {bodyText({
            ...
            {accent({
              ...
              en: "It's not just a tool for city-center managers. It's a territorial engagement mechanism that can adapt to other types of professionals.",
            }, lang)}

            {h3({ fr: "D'autres typologies de clients identifiées", en: 'Other client types identified' }, lang)}
            <div className="space-y-3 mb-10">
              {[
                {
                  title: { fr: 'Gestionnaires de centres commerciaux', en: 'Shopping mall managers' },
                  desc: { fr: "Même problématique de vacance, même besoin de suivi des enseignes, même enjeu de légitimité face aux propriétaires et aux investisseurs. Le mécanisme Cibler, Détecter, Sécuriser, Engager s'applique directement.", en: "Same vacancy issue, same need to track brands, same credibility challenge with owners and investors. The Target, Detect, Reassure, Engage mechanism applies directly." },
                },
                {
                  title: { fr: 'Brokers en immobilier commercial', en: 'Commercial real estate brokers' },
                  desc: { fr: "Besoin de veille sur les enseignes en expansion, de détection des opportunités avant les concurrents, de gestion d'un portefeuille de contacts et de locaux. City Manager pourrait devenir leur outil de prospection principal.", en: "Need to track expanding brands, spot opportunities ahead of competitors, manage a portfolio of contacts and units. City Manager could become their primary prospecting tool." },
                },
                {
                  title: { fr: 'Collectivités et agences de développement économique', en: 'Local authorities and economic development agencies' },
                  desc: { fr: "Suivi de l'attractivité économique d'un territoire, pilotage des zones d'activité, reporting aux élus. Un marché public potentiellement très large.", en: "Tracking an area's economic appeal, managing business zones, reporting to elected officials. A potentially very large public-sector market." },
                },
              ].map((item) => (
                <div
                  key={item.title.fr}
            ...
            {h3({ fr: "Ce que j'ai appris", en: 'What I learned' }, lang, 'mt-10')}
            {bodyText({
              ...
              en: "This project confirmed to me that discovery work is the most structuring part of a product project. Taking the time to understand a business before proposing a solution is what keeps you from building something useless, even if it's well made. I also learned to work with very different user profiles, and to design interfaces that don't assume a high level of technical comfort, without being condescending either.",
            }, lang)}
            <div className="my-4" />
            {bodyText({
              ...
              en: "Bringing AI into my design process was a revelation: not as a shortcut, but as an amplifier. It let me explore more broadly, document faster, and stay focused on what really matters: understanding users and making the right design decisions.",
            }, lang)}
          </section>
        )}
